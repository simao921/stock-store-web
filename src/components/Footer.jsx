    ...
    <footer className="bg-black border-t border-white/5 pt-32 pb-20 px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 relative z-10">
        ...
        <div className="space-y-8">
          <Link to="/" className="flex items-center gap-4 group">
            <div className="w-12 h-12 rounded-full bg-black border border-white/10 flex items-center justify-center p-1 shadow-lg shadow-red-600/10 group-hover:border-red-600/50 transition-all overflow-hidden">
          ...
          <div className="flex gap-4">
             <div className="p-3 rounded-2xl bg-white/5 border border-white/10 text-white/40 hover:text-red-600 transition-colors cursor-pointer"><Shield size={20} /></div>
             <div className="p-3 rounded-2xl bg-white/5 border border-white/10 text-white/40 hover:text-red-600 transition-colors cursor-pointer"><Zap size={20} /></div>
             <div className="p-3 rounded-2xl bg-white/5 border border-white/10 text-white/40 hover:text-red-600 transition-colors cursor-pointer"><Globe size={20} /></div>
          </div>
        </div>

        {/* Navigation */}
        <div className="space-y-8">
           <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-red-600">Explorar</h4>
        ...
        {/* Support */}
        <div className="space-y-8">
           <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-red-600">Legal</h4>
           <ul className="space-y-4">
      ...
      <div className="max-w-7xl mx-auto mt-32 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-6">
           <MessageSquare size={16} className="text-white/10 hover:text-red-600 cursor-pointer" />
           <Mail size={16} className="text-white/10 hover:text-red-600 cursor-pointer" />
        </div>
      </div>
    </footer>
  );
