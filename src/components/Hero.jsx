      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div 
            ...
            className="mb-6 px-5 py-2 rounded-2xl border border-red-600/20 bg-red-600/5 backdrop-blur-sm flex items-center gap-3"
          >
            <div className="w-2 h-2 bg-red-600 rounded-full animate-pulse shadow-[0_0_10px_#dc2626]" />
            <span className="text-red-500 text-[10px] font-black uppercase tracking-[0.2em]">O MELHOR PREÇO DO MERCADO</span>
          </motion.div>
