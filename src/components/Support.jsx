    ...
    <div className="min-h-screen bg-black pt-48 pb-20 px-8 relative">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-32">
          <span className="text-red-600 text-[10px] font-black uppercase tracking-[0.4em] mb-4 block">Assistência Prioritária</span>
        ...
        <div className="max-w-2xl mx-auto mb-32">
           <div className="glass-card p-16 flex flex-col items-center text-center border-white/5 group hover:border-red-600/30 transition-all">
              <div className="w-20 h-20 rounded-3xl bg-red-700/10 border border-red-600/20 flex items-center justify-center mb-10 text-red-600 group-hover:scale-110 transition-transform">
              ...
              <a 
                href="https://discord.gg/bHfGVeeaT5" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-full py-6 rounded-3xl bg-white text-black font-black uppercase tracking-widest text-[10px] hover:bg-red-700 hover:text-white transition-all shadow-xl shadow-white/5"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
           <div className="flex items-center gap-6 p-8 glass-card border-white/5">
              <Clock className="text-red-600 shrink-0" size={32} />
              <div>
