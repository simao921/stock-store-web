    ...
    <div className="min-h-screen bg-black pt-48 pb-20 px-8 relative">
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-32">
          <span className="text-red-600 text-[10px] font-black uppercase tracking-[0.4em] mb-4 block">Documentação Oficial</span>
        ...
        <div className="space-y-16">
          ...
          <section className="glass-card p-12 border-white/5">
            <div className="flex items-center gap-4 mb-8">
               <div className="w-10 h-10 rounded-xl bg-red-700/10 border border-red-600/20 flex items-center justify-center text-red-600">
                  <Shield size={20} />
               </div>
        ...
        <div className="mt-32 text-center">
           <p className="text-[10px] font-black text-white/10 uppercase tracking-[0.5em]">
              Dúvidas sobre os termos? <a href="https://discord.gg/bHfGVeeaT5" className="text-red-600 underline ml-2">Fale conosco no Discord</a>
           </p>
        </div>
